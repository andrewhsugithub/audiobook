/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings --env-file ../../.env.local` (hash: 7b855d6fbe4bd641773355d5e76e8840)
// Runtime types generated with workerd@1.20260520.1 2026-05-23 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	"my-audiobook-public-dev": R2Bucket;
	"my-audiobook-raw-uploads-dev": R2Bucket;
	"my-audiobook-media-dev": R2Bucket;
	HYPERDRIVE: Hyperdrive;
	PARSER_QUEUE: Queue;
	CHUNKING_QUEUE: Queue;
	TAGGING_QUEUE: Queue;
	VOICE_MAPPING_QUEUE: Queue;
	TTS_QUEUE: Queue;
	HLS_QUEUE: Queue;
	AI: Ai;
	RAW_BUCKET_NAME: "my-audiobook-raw-uploads-dev";
	MEDIA_BUCKET_NAME: "my-audiobook-media-dev";
	PUBLIC_ASSETS_BUCKET_NAME: "my-audiobook-public-dev";
	DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RAW_BUCKET_NAME" | "MEDIA_BUCKET_NAME" | "PUBLIC_ASSETS_BUCKET_NAME" | "DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "S3_ENDPOINT" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "TTS_URL" | "TTS_API_KEY" | "LOCALSTACK_AUTH_TOKEN" | "AWS_REGION" | "AWS_ENDPOINT" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "LLM_URL" | "CLOUDFLARE_ACCOUNT_ID" | "STORAGE_PROVIDER" | "LLM_API_TOKEN">> {}
}
